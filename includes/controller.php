...
function wpcf7_enqueue_scripts() {
	...
	wp_enqueue_script( 'valhalla-contact-form',
	...
	wp_localize_script( 'valhalla-contact-form', 'wpcf7', $wpcf7 );

	do_action( 'wpcf7_enqueue_scripts' );
}

function wpcf7_script_is() {
	return wp_script_is( 'valhalla-contact-form' );
}

function wpcf7_enqueue_styles() {
    
    wp_enqueue_style( 'bootstrap',
		wpcf7_plugin_url( 'includes/css/bootstrap.css' ),
		array(), '4.2.1', 'all' );
    wp_enqueue_style( 'valhalla-contact-form',
		wpcf7_plugin_url( 'includes/css/styles.css' ),
		array('bootstrap'), WPCF7_VERSION, 'all' );
    
	if ( wpcf7_is_rtl() ) {
		wp_enqueue_style( 'valhalla-contact-form-rtl',
...
function wpcf7_style_is() {
	return wp_style_is( 'valhalla-contact-form' );
}
